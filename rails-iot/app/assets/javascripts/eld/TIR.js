...
TIR.makeScene = function(box, params){
    ...
    var img_plane = new Path.Line({
        ...
        segments: [new paper.Point(led_ref.bounds.topCenter.x, ramp.bounds.topRight.y) , ramp.bounds.topRight], 
        strokeColor: "green", 
        strokeWidth: 1
    });
    img_plane.reverse();
